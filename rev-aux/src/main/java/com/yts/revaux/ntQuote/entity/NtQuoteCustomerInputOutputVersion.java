...
public class NtQuoteCustomerInputOutputVersion implements Serializable {
	...
	public String toString() {
		return "NtQuoteCustomerInputOutputVersion [id=" + id + ", srNo=" + srNo + ", uid=" + uid
				...
				+ purchaseComponentCostPart + ", secondaryOperationExternalProcess=" + secondaryOperationExternalProcess
				+ ", secondaryOperationLaborRate=" + secondaryOperationLaborRate + ", secondaryOperationMachineRate="
				+ secondaryOperationMachineRate + ", secondaryOperationCycleTime=" + secondaryOperationCycleTime
				+ ", externalOperationRate=" + externalOperationRate + ", preventativeMaintenanceFrequency="
				+ preventativeMaintenanceFrequency + ", preventativeMaintenanceCost=" + preventativeMaintenanceCost
				+ ", targetProfit=" + targetProfit + ", targetMaterialMarkup=" + targetMaterialMarkup
				+ ", actualMaterialCost=" + actualMaterialCost + ", partPerHours=" + partPerHours + ", estLotSize="
				+ estLotSize + ", setupHours=" + setupHours + ", externalOperationCostPer=" + externalOperationCostPer
				+ ", externalMachineCostPer=" + externalMachineCostPer + ", extendedLaborCostPer="
				+ extendedLaborCostPer + ", extendedMaterialCostPer=" + extendedMaterialCostPer
				+ ", packLogisticCostPer=" + packLogisticCostPer + ", totalProductionCost=" + totalProductionCost
				+ ", totalMaterialCost=" + totalMaterialCost + ", totalCostSgaProfit=" + totalCostSgaProfit
				+ ", sgaRate=" + sgaRate + ", profit=" + profit + ", partPrice=" + partPrice + ", totalCost="
				+ totalCost + ", totalSales=" + totalSales + ", totalProfit=" + totalProfit + ", costMaterial="
				+ costMaterial + ", totalContributionMargin=" + totalContributionMargin + ", contributionMargin="
				+ contributionMargin + ", materialContributionMargin=" + materialContributionMargin + ", version="
				+ version + ", comments=" + comments + ", createdBy=" + createdBy + ", createdDate=" + createdDate
