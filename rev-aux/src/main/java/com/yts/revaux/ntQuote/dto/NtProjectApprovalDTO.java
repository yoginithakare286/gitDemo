...
public class NtProjectApprovalDTO implements Serializable {
	...
	public String toString() {
		return "NtProjectApprovalDTO [id=" + id + ", srNo=" + srNo + ", uid=" + uid + ", approvedBy=" + approvedBy
				+ ", approvalDate=" + approvalDate + ", createdBy=" + createdBy + ", createdDate=" + createdDate
				+ ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate + ", ntQuote=" + ntQuote + "]";
	}
