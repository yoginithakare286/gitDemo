...
@Entity
@Table(name = "nt_quote_part_information_version")
public class NtQuotePartInformationVersion implements Serializable {
	...
	public String toString() {
		return "NtQuotePartInformationVersion [id=" + id + ", srNo=" + srNo + ", uid=" + uid + ", materialDescription="
				...
				+ ", partDescription=" + partDescription + ", jobId=" + jobId + ", moldId=" + moldId + ", quoteType="
				+ quoteType + ", comments=" + comments + ", createdBy=" + createdBy + ", createdDate=" + createdDate
