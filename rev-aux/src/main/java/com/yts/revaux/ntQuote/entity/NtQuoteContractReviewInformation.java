...
public class NtQuoteContractReviewInformation implements Serializable {
	...
	public String toString() {
		return "NtQuoteContractReviewInformation [id=" + id + ", srNo=" + srNo + ", uid=" + uid + ", contractNumber="
				+ contractNumber + ", revision=" + revision + ", reviewDate=" + reviewDate + ", createdBy=" + createdBy
